...
shiny::shinyUI(
  # navbarPage (6)
  navbarPage("Ecology data : Effect of specie, soil type and soil quality on tree mineral composition - Effect of nitrogen concentration increased in three compartments on three nutrients",
             br(),
